...
public class Driver {
    ...
    public static void testSingletonClassWithSerialization() throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream objectOutputStream = new ObjectOutputStream(Files.newOutputStream(new File("/Users/aakashverma/Documents/Learning/design-patterns-java/instance.ser").toPath()));
        objectOutputStream.writeObject(instance1);

        SingletonClassWithSerialization instance2 = null;
        ObjectInputStream objectInputStream = new ObjectInputStream(Files.newInputStream(new File("/Users/aakashverma/Documents/Learning/design-patterns-java/instance.ser").toPath()));
